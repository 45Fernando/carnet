        ...
        <Fragment>
            <ScrollView>
                {listaBeneficiarios.map(beneficiario => (
                    <Button key={beneficiario.affiliate.id} style={styles.boton} icon="card-account-details-outline" mode="contained" onPress={() => navigation.navigate('Carnet', beneficiario)}>
